...
export default function SignUpPage() {
  return (
    <div className="grid w-full flex-grow items-center bg-inherit px-4 sm:justify-center">
      <SignUp.Root>
        <SignUp.Step
          name="start"
          ...
          <div className="space-y-4">
            <div className='flex space-x-4'>
                <Clerk.Field name="firstName" className="w-full space-y-2">
                    <Clerk.Label className="text-sm font-medium text-white">First name</Clerk.Label>
                    <Clerk.Input
                    type="text"
                    required
                ...
                <Clerk.Field name="lastName" className="w-full space-y-2">
                    <Clerk.Label className="text-sm font-medium text-white">Last name</Clerk.Label>
                    <Clerk.Input
                    type="text"
                    required
                    className="w-full rounded-md bg-neutral-900 px-3.5 py-2 text-sm text-white outline-none ring-1 ring-inset ring-zinc-700 hover:ring-zinc-600 focus:bg-transparent focus:ring-[1.5px] focus:ring-blue-400 data-[invalid]:ring-red-400"
